...
function siteorigin_setting_editable_option_field(){
	siteorigin_settings_add_field('general', 'hover_edit', 'checkbox', __('Display Hover Edit Icon', 'focus'), array(
		'description' => __('Display a small icon that makes quickly editing fields easy. This is only shown to admin users.', 'focus'),
	));
}
	...
	switch ( $args['type'] ) {
		...
		case 'teaser' :
			...
			<a class="premium-teaser siteorigin-premium-teaser" href="<?php echo admin_url( 'themes.php?page=premium_upgrade' ) ?>" target="_blank">
				<em></em>
				<?php printf( __( 'Only available in <strong>%s Premium</strong> - <strong class="upgrade">Upgrade Now</strong>', 'focus' ), ucfirst($theme) ) ?>
