...
function siteorigin_panels_lite_admin_menu(){
	add_theme_page(
		__('Custom Home Page Builder', 'focus'),
		__('Home Page', 'focus'),
		'edit_theme_options',
		'so_panels_home_page',
...
function siteorigin_panels_lite_render_admin_home_page(){
	add_meta_box( 'so-panels-panels', __( 'Page Builder', 'focus' ), 'siteorigin_panels_metabox_render', 'appearance_page_so_panels_home_page', 'advanced', 'high' );
...
function siteorigin_panels_lite_enqueue_admin($prefix){
	...
	if($prefix == 'post.php' || $prefix == 'post-new.php' ) {
		...
		wp_localize_script('siteorigin-panels-lite-teaser', 'panelsLiteTeaser', array(
			'tab' => __('Page Builder', 'focus'),
			'message' => __("Refresh this page after you've installed Page Builder.", 'focus'),
