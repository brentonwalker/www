...
class SiteOrigin_Widgets_CTA extends WP_Widget {
	function __construct() {
		parent::__construct(
			'call-to-action',
			__( 'SiteOrigin Call To Action', 'focus' ),
			array(
				'description' => __( 'A call to action block, generally for your home page.', 'focus' ),
			)
		);
	}
	...
	function form( $instance ) {
		...
		?>
		<p>
			<label for="<?php echo $this->get_field_id( 'headline' ) ?>"><?php _e( 'Headline', 'focus' ) ?></label>
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'text' ) ?>"><?php _e( 'Text', 'focus' ) ?></label>
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'button' ) ?>"><?php _e( 'Button Text', 'focus' ) ?></label>
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'url' ) ?>"><?php _e( 'Button URL', 'focus' ) ?></label>
		...
		<?php if ( !empty( $button_styles ) ) : ?>
			<p>
				<label for="<?php echo $this->get_field_id( 'button_style' ) ?>"><?php _e( 'Button Style', 'focus' ) ?></label>
...
class SiteOrigin_Widgets_Button extends WP_Widget {
	function __construct() {
		parent::__construct(
			'button',
			__( 'SiteOrigin Button', 'focus' ),
			array(
				'description' => __( 'Display a button.', 'focus' ),
			)
		);
	}
	...
	function form( $instance ) {
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'align' ) ?>"><?php _e( 'Alignment', 'focus' ) ?></label>
			<select name="<?php echo $this->get_field_name( 'align' ) ?>" id="<?php echo $this->get_field_id( 'align' ) ?>">
				<option value="left" <?php selected( 'left', $instance['align'] ) ?>><?php esc_html_e( 'Left', 'focus' ) ?></option>
				<option value="center" <?php selected( 'center', $instance['align'] ) ?>><?php esc_html_e( 'Center', 'focus' ) ?></option>
				<option value="right" <?php selected( 'right', $instance['align'] ) ?>><?php esc_html_e( 'Right', 'focus' ) ?></option>
				<option value="full" <?php selected( 'full', $instance['align'] ) ?>><?php esc_html_e( 'Full Width', 'focus' ) ?></option>
			</select>
		</p>
...
class SiteOrigin_Widgets_IconText extends WP_Widget {
	function __construct() {
		parent::__construct(
			'icon-text',
			__( 'SiteOrigin Icon and Text', 'focus' ),
			array(
				'description' => __( 'A block of text with an icon.', 'focus' ),
			)
		);
	}
	...
	function form( $instance ) {
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'url' ) ?>"><?php _e( 'URL', 'focus' ) ?></label>
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'icon' ) ?>"><?php _e( 'Icon', 'focus' ) ?></label>
		...
		<p class="description">
			<?php
			printf(
				__('Upload icon images to your <a href="%s" target="_blank">media library</a>. Find <a href="%s" target="_blank">free icon packs</a>.', 'focus'),
...
class SiteOrigin_Widgets_Headline extends WP_Widget {
	function __construct() {
		parent::__construct(
			'headline',
			__( 'SiteOrigin Headline', 'focus' ),
			array(
				'description' => __( 'Displays a simple headline.', 'focus' ),
			)
		);
	}
	...
	function form( $instance ) {
		...
		?>
		<p>
			<label for="<?php echo $this->get_field_id( 'headline' ) ?>"><?php _e( 'Headline Text', 'focus' ) ?>
			<input type="text" class="widefat" name="<?php echo $this->get_field_name( 'headline' ) ?>" id="<?php echo $this->get_field_id( 'headline' ) ?>" value="<?php echo esc_attr( $instance['headline'] ) ?>" />
		</p>
	
		<p>
			<label for="<?php echo $this->get_field_id( 'size' ) ?>"><?php _e( 'Size', 'focus' ) ?></label>
			<select name="<?php echo $this->get_field_name( 'size' ) ?>" id="<?php echo $this->get_field_id( 'size' ) ?>">
				<option value="small" <?php selected( 'small', $instance['size'] ) ?>><?php esc_html_e( 'Small', 'focus' ) ?></option>
				<option value="medium" <?php selected( 'medium', $instance['size'] ) ?>><?php esc_html_e( 'Medium', 'focus' ) ?></option>
				<option value="large" <?php selected( 'large', $instance['size'] ) ?>><?php esc_html_e( 'Large', 'focus' ) ?></option>
				<option value="extra-large" <?php selected( 'extra-large', $instance['size'] ) ?>><?php esc_html_e( 'Extra Large', 'focus' ) ?></option>
			</select>
		</p>
