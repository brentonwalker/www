 ...
 * @return string
 */
function portal_gallery($contents, $attr){
	...
	foreach($attachments as $attachment){
		$return .= '<li>';
		$return .= apply_filters('portal_slide_before', '', $attachment);
		...
		$return .= apply_filters('portal_slide_after', '', $attachment);
		$return .= '</li>';
	}
	$return .= '</ul>';
	$return .= '</div>';
...
add_filter('post_gallery', 'portal_gallery', 10, 2);
 ...
 * @since portal 1.0
 */
function portal_gallery_types($types){
	$types['slider'] = __('Slider', 'portal');
	return $types;
}
add_filter('siteorigin_gallery_types', 'portal_gallery_types');
 ...
 * @since portal 1.0
 */
function portal_gallery_default_type(){
	return 'slider';
}
add_filter('siteorigin_gallery_default_type', 'portal_gallery_default_type');