...
<div id="container" class="grid_16">
  <div id="content" role="main">
    <h1 class="entry-title author"><?php printf( __( 'Author Archives: %s', 'bizstudio' ), "<span class='vcard'><a class='url fn n' href='" . get_author_posts_url( get_the_author_meta( 'ID' ) ) . "' title='" . esc_attr( get_the_author() ) . "' rel='me'>" . get_the_author() . "</a></span>" ); ?></h1>
    <?php if(have_posts()) : ?>
