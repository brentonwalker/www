...
<div id="container" class="grid_16">
  <div id="content" role="main">
    <h1 class="entry-title"><?php printf( __( 'Search Results for: %s', 'bizstudio' ), '<span>' . get_search_query() . '</span>' ); ?></h1>
    <?php if(!is_home()){
    ...
    <div class="post">
      <h2>
        <?php _e('Sorry, but nothing matched your search criteria. Please try again with some different keywords.','bizstudio'); ?>
      </h2>
    </div>
    <?php endif; ?>
  </div>
