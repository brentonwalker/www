<?php
class bizstudio_breadcrumb_class {
var $opts;
...
global $post, $options;
#require('var.php');
echo '<section class="cont_nav"><div class="cont_nav_inner"><p><a href="' . esc_url(home_url('/')) . '">' . __('Home', 'bizstudio') . '</a>';
if (!is_front_page()) {
echo $markup;
}
...
return __('Author', 'bizstudio') . ': ' . $curauth->display_name;
}
if (is_tag()) {
return __('Tag', 'bizstudio') . ': ' . single_tag_title('', false);
}
if (is_search()) {
return __('Search', 'bizstudio');
}
if (is_year()) {
...
$bizstudio_breadcumb = new bizstudio_breadcrumb_class();
?>