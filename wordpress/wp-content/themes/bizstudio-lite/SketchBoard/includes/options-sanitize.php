...
function of_recognized_background_repeat() {
	$default = array(
		'no-repeat' => __('No Repeat', 'bizstudio'),
		'repeat-x'  => __('Repeat Horizontally', 'bizstudio'),
		'repeat-y'  => __('Repeat Vertically', 'bizstudio'),
		'repeat'    => __('Repeat All', 'bizstudio'),
		);
...
function of_recognized_background_position() {
	$default = array(
		'top left'      => __('Top Left', 'bizstudio'),
		'top center'    => __('Top Center', 'bizstudio'),
		'top right'     => __('Top Right', 'bizstudio'),
		'center left'   => __('Middle Left', 'bizstudio'),
		'center center' => __('Middle Center', 'bizstudio'),
		'center right'  => __('Middle Right', 'bizstudio'),
		'bottom left'   => __('Bottom Left', 'bizstudio'),
		'bottom center' => __('Bottom Center', 'bizstudio'),
		'bottom right'  => __('Bottom Right', 'bizstudio')
		);
...
function of_recognized_background_attachment() {
	$default = array(
		'scroll' => __('Scroll Normally', 'bizstudio'),
		'fixed'  => __('Fixed in Place', 'bizstudio')
		);
...
function of_recognized_font_styles() {
	$default = array(
		'normal'      => __('Normal', 'bizstudio'),
		'italic'      => __('Italic', 'bizstudio'),
		'bold'        => __('Bold', 'bizstudio'),
		'bold italic' => __('Bold Italic', 'bizstudio')
		);
