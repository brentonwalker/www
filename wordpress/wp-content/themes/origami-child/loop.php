	...
	<?php while(have_posts()) : the_post(); global $post; ?>
		<div <?php post_class() ?>>
			...
			<?php if(!in_array(get_post_format(), array('aside', 'link', 'status'))) : ?>
				...
				<div class="post-info">
					<?php printf(__('%s', 'origami'), get_the_date()) ?>
			...
			<?php if(is_single() && siteorigin_setting('display_next_prev')) : ?>
				<div class="post-navigation">
					<?php next_post_link('<div id="blog_nextPost">Next Post: %link</div>'); previous_post_link('<div id="blog_prevPost">Previous Post: %link</div>'); ?>
					<div class="clear"></div>
				</div>
			<?php endif; ?>
