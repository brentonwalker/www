...
/*-----------------------------------------------------------------------------------*/
	...
	$( 'input.upload_button' ).removeAttr( 'style' );
      ...
      $( 'input.upload_button').live( "click", function () {
       ...
       if ( $(this).parents( '.section').find( '.heading') ) { colabs_title = $(this).parents( '.section').find( '.heading').text(); } // End IF Statement
        
        // tb_show( colabs_title, 'media-upload.php?post_id='+formID+'&type=image&amp;is_colabsthemes=yes&amp;colabs_title=' + colabs_title + '&amp;TB_iframe=1&amp;width=630&amp;height=500' );
        
        // tb_show( colabs_title, 'media-upload.php?post_id='+formID+'&type=image&amp;is_colabsthemes=yes&amp;TB_iframe=1&amp;width=630&amp;height=500' );
        
        tb_show( colabs_title, 'media-upload.php?post_id='+formID+'&amp;TB_iframe=1' );
        return false;
      });
