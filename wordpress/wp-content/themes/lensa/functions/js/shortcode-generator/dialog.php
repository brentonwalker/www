...
<div id="colabs-options-error">
    ...
    <p><?php echo sprinf ( __( 'Your version of the CoLabsFramework (%s) does not yet support shortcodes. Shortcodes were introduced with version %s of the framework.', 'colabsthemes' ), $colabs_framework_version, $MIN_VERSION ); ?></p>
