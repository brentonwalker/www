...
if ( '' != get_the_post_thumbnail( $post->ID ) ) :
	...
	// If the image is wider than or equal to 960, and at taller than or equal to 350, add class and show image
...
?>
			...
			<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
				...
				<header class="entry-header">
					<h1 class="entry-title"><a href="<?php the_permalink(); ?>" title="<?php echo esc_attr( sprintf( __( 'Permalink to %s', 'sidekick' ), the_title_attribute( 'echo=0' ) ) ); ?>" rel="bookmark"><?php the_title(); ?></a></h1>
