...
if (($pgallery) =='option-3') { //GALLERY - SLIDESHOW
                ...
                <?php
				$args = array('post_type' => 'attachment', 'orderby' => 'menu_order', 'order' => ASC, 'numberposts' => -1, 'post_status' => null, 'post_parent' => $post -> ID, 'exclude' => get_post_thumbnail_id());
                ...
                ?>							
				<?php  } 
				elseif (($pgallery) =='option-2')  { //GALLERY - 2 COLUMNS, LIGHTBOX
					echo do_shortcode('[gallery link="file" size="s-gallery" columns="2" ]');
					} else { //GALLERY - 1 COLUMNS
					$args = array(
