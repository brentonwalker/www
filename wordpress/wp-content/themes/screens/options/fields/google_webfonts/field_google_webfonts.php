...
class NHP_Options_google_webfonts extends NHP_Options{	
	...
	*/
	function render(){
		...
		echo '<p class="description" style="color:red;">'.__('The fonts provided below are free to use custom fonts from the Google Web Fonts directory.<br/>Please browse the directory to preview a font, then select your choice below.', 'nhp-opts').'</p>';
