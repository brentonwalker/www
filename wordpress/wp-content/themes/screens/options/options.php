...
class NHP_Options{
	...
	*/
	function __construct($sections = array(), $args = array(), $extra_tabs = array()){
		...
		$defaults['menu_title'] = __('Options', 'screens');
		$defaults['page_icon'] = 'icon-themes';
		$defaults['page_title'] = __('Options', 'screens');
		...
		$defaults['footer_credit'] = __('<span id="footer-thankyou">Options Panel created using the <a href="http://leemason.github.com/NHP-Theme-Options-Framework/" target="_blank">NHP Theme Options Framework</a> Version  1.0.6</span>', 'nhp-opts');
		
		$defaults['help_tabs'] = array();
		$defaults['help_sidebar'] = __(' ' , 'screens');
